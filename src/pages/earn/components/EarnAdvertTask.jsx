        ...
        <div className=' min-h-screen w-full p-3 flex-col justify-start items-start gap-3 inline-flex'>
          ...
          {fetchTask?.map((task, index) => (
            <>
              ...
              >
                <div className='grow shrink basis-0 self-stretch p-3 dark:bg-black  bg-zinc-400 bg-opacity-30 rounded-lg flex-col justify-start items-center gap-10 inline-flex'>
                  <div className='self-stretch py-6 flex-col justify-start items-center gap-3 flex'>
                    <div className='self-stretch py-3 justify-start items-start gap-2 inline-flex'>
                      <div className="grow dark:text-white shrink basis-0 text-center text-stone-900 text-2xl font-medium font-['Campton']">
                        Task
                      </div>
                    </div>
                  </div>
                  <div className=' flex-col justify-start items-center gap-8 flex'>
                    <div className='self-stretch  flex-col justify-start items-center gap-3  flex'>
                      <div className='self-stretch'>
                        <span className=" dark:text-white text-black text-xs font-semibold font-['Campton']">
                          Please follow the step-by-step instructions below to
                          do your task:
                          <br />
                          Step 1: 
                        </span>
                        <span className="text-black dark:opacity-60 dark:text-white text-xs font-normal font-['Campton']">
                        ...
                        <span className="text-black dark:text-white text-xs font-semibold font-['Campton']">
                          Step 3: 
                        </span>
                        <span className="text-black dark:opacity-60 dark:text-white text-xs font-normal font-['Campton']">
                        ...
                        <span className="text-black  dark:text-white dark:opacity-60 text-xs font-normal font-['Campton']">
                      ...
                      <div className='self-stretch'>
                        ...
                        {task?.task?.media_path && (
                          <span className="text-black dark:text-white text-xs font-normal font-['Campton']">
                            Download the image{' '}
                            <Image
                              className='w-40 h-40'
                        ...
                        <span className="text-black dark:opacity-60 dark:text-white text-xs font-normal font-['Campton']">
                          Get view of{' '}
                          <strong>
                            {task?.task?.posts_count ||
                              task?.task?.engagements_count}
                          </strong>
                          <br />
                        </span>
