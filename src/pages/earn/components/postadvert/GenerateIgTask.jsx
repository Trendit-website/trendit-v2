          ...
          <div className='self-stretch flex-col justify-start items-start flex'>
            <div className='self-stretch h-[447px] pb-6 dark:bg-white bg-stone-900 border border-stone-900 flex-col justify-center items-center gap-6 flex'>
              ...
              </div>
              {
                ...
                <h2 className='text-white dark:text-zinc-700 font-bold text-[14px] sm:text-xl'>Your Instagram Profile Account</h2>
                ...
                </div>
                {
                  ...
                  Your Instagram task must be done from the above Instagram profile which has been linked to your Trendit³ account
                  </p> :''
                }
            </div> : ''
              }
