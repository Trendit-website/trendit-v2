  ...
  return (
    <div>
      <Modal
        ...
        onClose={onClose}
      >
        <ModalContent className='md:w-[30rem] '>
          <div className=' h-[699.59px] p-12 bg-white rounded flex-col justify-center items-center gap-12 inline-flex'>
            <div
              onClick={onClose}
            ...
            <div className='h-[392.59px] flex-col justify-start items-center gap-3 flex'>
              <div className='self-stretch h-[306.59px] p-6 bg-zinc-400 bg-opacity-30 rounded-lg flex-col justify-start items-start gap-2 flex'>
                <div className='w-[339px] h-[148.59px] relative bg-neutral-800'>
                  <img
                    className='w-[339px] h-[149px] left-0 top-0 absolute opacity-50'
                    src={imgplaceholder}
                  />
                ...
                <div className='self-stretch justify-start items-start gap-2 inline-flex'>
                  <div className='grow shrink basis-0 flex-col justify-start items-start gap-3 inline-flex'>
                    ...
                    <div className='self-stretch justify-start items-center gap-3 inline-flex'>
                      <div className='grow shrink basis-0 h-[23px] p-2 bg-white rounded-sm border border-violet-500 border-opacity-25 justify-center items-center gap-1 flex'>
                        <div className="text-center text-black text-[10px] font-medium font-['Campton']">
                          Buy this product
                        </div>
                      </div>
                      <div className='grow shrink basis-0 h-[23px] p-2 bg-fuchsia-400 rounded-sm border border-violet-500 border-opacity-25 justify-center items-center gap-1 flex'>
