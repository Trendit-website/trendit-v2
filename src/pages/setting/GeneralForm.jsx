...
export default function GeneralForm() {
  ...
  const day = birthdayDate.getDate().toString().padStart(2, '0') // Add leading zero if necessary
  ...
  const {
    ...
    defaultValues: {
      ...
      month,
      year,
      // day: profileDeatils?.birthday
      //   ? profileDeatils?.birthday.split('-')[2]
      //   : '',
      // month: profileDeatils?.birthday
      //   ? profileDeatils?.birthday.split('-')[1]
      //   : '',
      // year: profileDeatils?.birthday
      //   ? profileDeatils?.birthday.split('-')[0]
      //   : '',
    },
  })
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className='self-stretch grow shrink w-full  basis-0 md:px-16 py-6 flex-col justify-start items-start gap-12 flex'>
            ...
            <div className='self-stretch  cursor-pointer justify-start items-center gap-[7px] inline-flex'>
              ...
              <div
                onClick={onOpen}
                className="text-center cursor-pointer text-orange-600 text-sm font-medium font-['Campton']"
              >
                Delete account
              </div>
            </div>
