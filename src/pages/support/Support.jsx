    ...
    <div>
      <div className=' p-3 flex-col justify-start items-start gap-3 inline-flex'>
        <div className='self-stretch grow shrink basis-0 flex-col justify-start items-start gap-4 flex'>
          <div className='self-stretch  flex-col justify-start items-start gap-2 flex'>
            <div className='self-stretch border-b border-stone-900 justify-center items-center inline-flex'>
              <div className='grow pt-16 pb-6 flex flex-col justify- items-center'>
                <div className="w-[236px] text-center pb-12 gap-8 text-white text-2xl font-medium font-['Campton']">
          ...
          <div className='w-full w[1107px] h-9 px-3 py-1.5 bg-zinc-900 rounded justify-start items-center gap-2 inline-flex'>
            <Input
