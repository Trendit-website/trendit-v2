                  ...
                  <div className='self-stretch flex-col justify-start items-center gap-3 flex'>
                    <div className='self-stretch'>
                      ...
                      <span className=" text-xs font-normal font-['Manrope']">
                        Open the Task Link above on your {taskPreview?.platform}{' '}
                      ...
                      <span className=" text-xs font-normal font-['Manrope']">
                        The link will direct you to a {taskPreview?.platform}{' '}
                        {''} Page which you are meant to like and follow.
                        <br />
                      </span>
                      <span className=" text-xs font-semibold font-['Manrope']">
                        Step 3: 
                      ...
                      <span className=" text-xs font-normal font-['Manrope']">
                        ...
                        {taskPreview?.platform} {''} Page to start liking or
                        following the page. You MUST NOT Unfollow the account
                        after you have followed the account.
                        <br />
                      </span>
                      <span className=" text-xs font-semibold font-['Manrope']">
                        Step 4: 
                      ...
                      <span className=" text-xs font-normal font-['Manrope']">
                        ...
                        required to enter your {taskPreview?.platform} {''}{' '}
                        Username or Name which you used to perform the task
                      </span>
                    </div>
